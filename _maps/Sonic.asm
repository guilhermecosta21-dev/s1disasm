Map_417b: mappingsTable
	...
	mappingsTableEntry.w	Map_5024_87
	mappingsTableEntry.w	Map_5024_88
...
MS_WaterSlide:	spriteHeader
 spritePiece -$10, -$B, 4, 2, 0, 0, 0, 0, 0
 spritePiece -8, -$1B, 2, 2, 8, 0, 0, 0, 0
 spritePiece -8, 5, 2, 2, $C, 0, 0, 0, 0
MS_WaterSlide_End

MS_GetAir:	spriteHeader
 spritePiece -$C, -$18, 3, 3, 0, 0, 0, 0, 0
 spritePiece -4, 0, 2, 3, 9, 0, 0, 0, 0
MS_GetAir_End
