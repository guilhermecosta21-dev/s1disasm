	...
	class SwingingSpikeball : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../artkospm/SYZ Large Spikeball.kospm", CompressionType.KosinskiPlusM), "../../_maps/Big Spiked Ball.asm", labels[i], i == 2 ? 2 : 0));
		}
