	...
	class SwingingPlatform : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../artkospm/SLZ Swinging Platform.kospm", CompressionType.KosinskiPlusM), "../../_maps/Swinging Platforms (SLZ).asm", labels[i], i == 1 ? 0 : 2));
		}
