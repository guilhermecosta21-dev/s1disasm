...
namespace S1ObjectDefinitions.SYZ
{
	class SpikeballChain : ObjectDefinition
	{
		...
		{
			img = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../artkospm/SYZ Small Spikeball.kospm", CompressionType.KosinskiPlusM), "../../_maps/Spiked Ball and Chain (SYZ).asm", 0, 0);
		}
